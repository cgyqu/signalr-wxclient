        ...
        return new Promise(function (resolve, reject) {
          ...
          wx.request({
            ...
            success: function (res) {
              ...
              resolve(new HttpResponse(res.statusCode, res.errMsg, data));
            },
            fail: function (err) {
              reject(new Errors.HttpError("fail", "error"));
            }
          })
        ...
        if (transport === null || transport === undefined) {
          ...
          if (transportMatches(requestedTransport, transport)) {
            if (transferFormats.indexOf(requestedTransferFormat) >= 0) {
              //transport === ITransport.HttpTransportType.WebSockets && typeof WebSocket === "undefined") ||
              if ((transport === ITransport.HttpTransportType.ServerSentEvents && typeof EventSource === "undefined")) {
